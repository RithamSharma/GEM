...
fn main() {
    ...
    #[cfg(feature = "cuda")] {
        ...
        // ------------------------------------------------------------------
        // V2 heterogeneous formatter self-check kernel. Separate feature so a
        // V2 CUDA change can never break the `--features cuda` submission
        // build; `--features v2` implies `cuda` (see Cargo.toml).
        // ------------------------------------------------------------------
        #[cfg(feature = "v2")] {
