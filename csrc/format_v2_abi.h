...
static constexpr uint32_t V2_VERSION      = 2;
static constexpr int      V2_HEADER_WORDS = 64;
...
//   DSP  src: A27 D27 B18 C48 OPMODE9 ALUMODE4 INMODE5 CEP1 RSTP1 CLK1 (= 141)
//   DSP  dst: P48
//   CARRY4 src: S4 DI4 CIN1 CYINIT1  (= 10)   dst: O4 CO4  (= 8)
//   SRLC   src: D1 CE1 A5 CLK1 (= 8)            dst: Q1 Q31_1  (= 2)
static constexpr int DSP_SRC_BITS    = 141;
static constexpr int DSP_DST_BITS    = 48;
static constexpr int CARRY4_SRC_BITS = 10;
static constexpr int CARRY4_DST_BITS = 8;
static constexpr int SRLC_SRC_BITS   = 8;
...
static_assert(DSP_SRC_BITS == 27+27+18+48+9+4+5+1+1+1, "dsp src field table");
#endif
